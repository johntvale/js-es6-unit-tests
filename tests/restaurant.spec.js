...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.strictEqual(typeof (objetoRetornado.fetchMenu), 'function'); // OK
    ...
    assert.deepStrictEqual(objetoRetornado.fetchMenu(), { food: {}, drink: {}}); // OK
    ...
    // ```
    objetoRetornado(objetoQualquer);
    assert.strictEqual(objetoRetornado.fetchMenu(), objetoQualquer); //aguardando teste
